...
final class BatteryLogViewController: ThemedViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    lazy var filterButton: UIBarButtonItem = {
        ...
        button.accessibilityLabel = "Visa endast saknade batterivärden"
        return button
    }()
    ...
    @objc private func toggleMissingOnly() {
        ...
        filterButton.accessibilityLabel = showOnlyMissingBattery
            ? "Visa alla batterivärden" : "Visa endast saknade batterivärden"
